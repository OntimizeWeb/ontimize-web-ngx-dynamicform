...
export const BOOTSTRAP_MODULE     = 'index';

export const APP_TITLE            = 'ontimize-web-ng2-dynamicform';
...
export const CSS_PROD_BUNDLE      = 'o-dynamic-form.css';
export const JS_PROD_SHIMS_BUNDLE = 'shims.js';
export const JS_PROD_APP_BUNDLE   = 'index.js';
